// Based on https://github.com/plietar/spotify-connect
// Added Zeroconf discovery and login
...
static int print_vars(void) {
    ...
    printf("public key: %s\n", vars.publicKey);
    HttpSetPublicKey(vars.publicKey);
    printf("device id: %s\n", vars.deviceId);
    HttpSetDeviceID(vars.deviceId);
    printf("activeUser: %s\n", vars.activeUser);
    printf("remote name: %s\n", vars.remoteName);
    HttpSetName(vars.remoteName);
